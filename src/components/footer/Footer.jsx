...
export default function Footer() {
  return (
    <>
      <footer className='bg-[#070f1c] px-20 md:px-30 py-20'>
        <div className='flex justify-center gap-15 flex-wrap'>
          <div>
            ...
            <p className='text-white text-sm opacity-60 mt-2'>
              ...
              graphic, print, and <br /> layouts and visual mockups.
            </p>

            <p className='text-white flex items-center gap-3 text-md mt-5'>
              <IoMailOutline /> Company@gmail.com.com
            </p>
            <p className='text-white flex items-center gap-3 text-md mt-2'>
              <TbPhoneCall /> Phone: (064) 332-1233
            </p>
            <p className='text-white flex items-center gap-3 text-md mt-2'>
              <HiOutlineLocationMarker /> 450 Wall Street, USA, New York
            </p>
          </div>
          <div>
            <h2 className='text-white text-lg font-semibold'>INFORMATION</h2>
            <a href='#' className='text-white block mt-5 opacity-60'>
              New Collection
            </a>
            <a href='#' className='text-white block mt-2 opacity-60'>
              About Store
            </a>
            <a href='#' className='text-white block mt-2 opacity-60'>
              Contact Us
          ...
          <div>
            ...
            <p className='text-white text-sm opacity-60 mt-5'>
              Lorem ipsum is placeholder text <br /> commonly used in the
              graphic, print, and <br /> layouts and visual mockups.
            </p>

            <h2 className='text-white text-md mt-5 font-semibold'>
              www.company.com
            </h2>
